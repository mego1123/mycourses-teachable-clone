...
// Creator studio pages (lazy — only loaded by creators)
const CreatorLayout = lazy(() => import('./components/CreatorLayout'));
const CreatorDashboardPage = lazy(() => import('./pages/studio/CreatorDashboardPage'));
const CoursesPage = lazy(() => import('./pages/studio/CoursesPage'));
const CourseEditorPage = lazy(() => import('./pages/studio/CourseEditorPage'));
const CouponsPage = lazy(() => import('./pages/studio/CouponsPage'));
const SalesPage = lazy(() => import('./pages/studio/SalesPage'));
const CustomDomainPage = lazy(() => import('./pages/studio/CustomDomainPage'));
const ReviewsPage = lazy(() => import('./pages/studio/ReviewsPage'));
const ConnectOnboardingPage = lazy(() => import('./pages/studio/ConnectOnboardingPage'));
const PayoutsPage = lazy(() => import('./pages/studio/PayoutsPage'));

// Storefront + learner pages (lazy)
const StorefrontHomePage = lazy(() => import('./pages/storefront/StorefrontHomePage'));
const CourseDetailPage = lazy(() => import('./pages/storefront/CourseDetailPage'));
const CheckoutPage = lazy(() => import('./pages/storefront/CheckoutPage'));
const CertificateVerifyPage = lazy(() => import('./pages/storefront/CertificateVerifyPage'));
const MyCoursesPage = lazy(() => import('./pages/learn/MyCoursesPage'));
                ...
                <BrowserRouter>
                  ...
                  <Routes>
                    ...
                    <Route element={<ProtectedRoute />}>
                      ...
                      <Route path="/studio" element={<Suspense fallback={<LazyFallback />}><CreatorLayout /></Suspense>}>
                        <Route index element={<Navigate to="/studio/dashboard" replace />} />
                        <Route path="dashboard" element={<Suspense fallback={<LazyFallback />}><CreatorDashboardPage /></Suspense>} />
                        <Route path="courses" element={<Suspense fallback={<LazyFallback />}><CoursesPage /></Suspense>} />
                        <Route path="courses/:id/edit" element={<Suspense fallback={<LazyFallback />}><CourseEditorPage /></Suspense>} />
                        <Route path="coupons" element={<Suspense fallback={<LazyFallback />}><CouponsPage /></Suspense>} />
                        <Route path="sales" element={<Suspense fallback={<LazyFallback />}><SalesPage /></Suspense>} />
                        <Route path="domain" element={<Suspense fallback={<LazyFallback />}><CustomDomainPage /></Suspense>} />
                        <Route path="reviews" element={<Suspense fallback={<LazyFallback />}><ReviewsPage /></Suspense>} />
                        <Route path="connect" element={<Suspense fallback={<LazyFallback />}><ConnectOnboardingPage /></Suspense>} />
                        <Route path="payouts" element={<Suspense fallback={<LazyFallback />}><PayoutsPage /></Suspense>} />
                      </Route>

                      {/* Learner routes */}
                      <Route path="/learn/my-courses" element={<Suspense fallback={<LazyFallback />}><MyCoursesPage /></Suspense>} />
                      <Route path="/learn/course/:courseId" element={<Suspense fallback={<LazyFallback />}><CoursePlayerPage /></Suspense>} />
                      <Route path="/learn/course/:courseId/:lessonId" element={<Suspense fallback={<LazyFallback />}><CoursePlayerPage /></Suspense>} />

                      {/* Storefront routes (public — accessible without auth for browsing) */}
                      <Route path="/courses" element={<Suspense fallback={<LazyFallback />}><StorefrontHomePage /></Suspense>} />
                      <Route path="/courses/:slug" element={<Suspense fallback={<LazyFallback />}><CourseDetailPage /></Suspense>} />
                      <Route path="/checkout/:courseSlug" element={<Suspense fallback={<LazyFallback />}><CheckoutPage /></Suspense>} />
                      <Route path="/certificates/verify/:token" element={<Suspense fallback={<LazyFallback />}><CertificateVerifyPage /></Suspense>} />
